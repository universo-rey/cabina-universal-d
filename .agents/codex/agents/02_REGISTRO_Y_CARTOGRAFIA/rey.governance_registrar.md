...
1. `01_GOVERNANCE_REGISTRY\UNIVERSES.csv`
2. `01_GOVERNANCE_REGISTRY\CONTROL_TOWERS.csv`
3. `01_GOVERNANCE_REGISTRY\REPOSITORIES.csv`
4. `01_GOVERNANCE_REGISTRY\OWNER_MATRIX.csv`
5. `01_GOVERNANCE_REGISTRY\RELATIONSHIP_GRAPH.json`
...
- Ruta local: C:\Users\enzo1\.codex\workpapers\rey.governance_registrar
