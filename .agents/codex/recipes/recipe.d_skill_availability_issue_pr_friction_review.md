...
## Preconditions
- `AGENTS.md` remains the local governing source.
...
## Steps
1. Read `.agents\codex\matrices\LOCAL_SKILL_CATALOG.csv`.
2. Verify every `d_drive_repo_local` skill has a matching directory under `.agents\skills`.
