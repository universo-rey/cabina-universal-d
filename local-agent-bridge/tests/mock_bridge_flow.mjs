...
assert.equal(dashboard.canvas_workbench.status, "MESA_LOCAL_ACTIVA");
assert.equal(dashboard.canvas_workbench.project_name, "Control de Agentes de la Cabina Universal");
